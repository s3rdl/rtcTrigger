...
struct AppSettings {
  ...
  String bleWakeTimes;
  bool bleOneShotEnabled;
  uint16_t bleOneShotYear;
  uint8_t bleOneShotMonth;
  uint8_t bleOneShotDay;
  uint8_t bleOneShotHour;
  uint8_t bleOneShotMinute;
  uint32_t powerHoldMs;
  uint32_t bootDelayMs;
  uint32_t modePressMs;
  uint32_t bleWindowMs;
  bool bleIntervalWakeEnabled;
...
constexpr bool bleOneShotEnabled = false;
constexpr uint16_t bleOneShotYear = 2026;
constexpr uint8_t bleOneShotMonth = 1;
constexpr uint8_t bleOneShotDay = 1;
constexpr uint8_t bleOneShotHour = 8;
constexpr uint8_t bleOneShotMinute = 0;
...
constexpr bool bleIntervalWakeEnabled = true;
